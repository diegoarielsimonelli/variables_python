...
print("Su nombre completo es:", nombre, "" + apellido, "y su N° de DNI es", DNI)
print("Su nombre completo es:", nombre,""  + apellido,"tiene",edad, "de edad y su altura es de", altura, "metros")
